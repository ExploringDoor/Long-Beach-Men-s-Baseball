    ...
    <div style={{minHeight:"100vh",fontFamily:"'Barlow',sans-serif",width:"100%",maxWidth:"100%",overflowX:"hidden"}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .hero-img { width: 100%; max-height: 280px; object-fit: cover; object-position: center bottom; display: block; }
        @media(max-width:700px){
          .hero-img { width: 100%; max-height: 180px; object-fit: cover; object-position: center bottom; }
